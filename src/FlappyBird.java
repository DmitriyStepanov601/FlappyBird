...
public class FlappyBird implements Game {
	...
	private Action addPipe(){
		return () -> pipes.add(new Pipe(getWidth(), generator.nextInt(getHeight() - 112 - Pipe.HOLESIZE)));
	}
	...
	public void drawScreen(Screen screen) {
		...
		screen.setImage("/sprites.png", 292, 0, 308, 112, 0,
				(308 * 2) - ground_offset, getHeight() - 112);
		switch(game_state){
		case 0:
			...
			screen.textmessage("Press space", 100, getHeight()/2 - 16, 32, ColorThing.WHITECOLOR);
			break;
		case 1:
		...
		case 3:
			...
			screen.setImage("/sprites.png", 292, 116, 226, 116, 0,
					(double)getWidth() / 2 - (double)226 / 2, (double)getHeight() / 2 - (double)116 / 2);
